...
from isaaclab_tasks.stack_3cube_v2.reach_stack_env_cfg import LiftEnvCfg
...
class MyFanucCubeLiftPlaceEnvCfg(LiftEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.object = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=[0.7, -0.05, 0.055], rot=[1, 0, 0, 0]),
            spawn=UsdFileCfg(
        ...
        self.scene.cube1 = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=[0.7, 0.1, 0.055], rot=[1, 0, 0, 0]),
            spawn=UsdFileCfg(
